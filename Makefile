...
PACKAGE = github.com/zinadesign/hugo
...
fmt: ## Run gofmt linter
	@for d in `govendor list -no-status +local | sed 's/github.com.zinadesign.hugo/./'` ; do \
...
test-cover-html: PACKAGES = $(shell govendor list -no-status +local | sed 's/github.com.zinadesign.hugo/./')
