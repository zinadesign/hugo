...
1. Download the latest zipped Hugo executable from the [Hugo Releases](https://github.com/zinadesign/hugo/releases) page.
...
1. Go the [Hugo Releases](https://github.com/zinadesign/hugo/releases) page.
